// Android 12 can be limited to WebView 96. The bundle and stylesheet are
// therefore built for Chromium 96; anything older misses CSS features that
// carry the whole layout.
const MIN_ANDROID_WEBVIEW_VERSION = 96;
...
export function renderBlockingPage(): HTMLElement {
	return blockingPage("Android System WebView 96 or newer is required.");
}
